        ...
        <form method="POST" action="<?= SITE_URL ?>categoria/<?= $aDados['acao'] ?>">
            <div class="row">
                <div class="form-group col-lg-4 col-sm-6">
                    ...
                    <input type="text" name="descricao" id="descricao" class="form-control" maxlength="100" <?= Helpers::$acoesInput[$aDados['acao']]['readonly'] ?> value="<?= isset($aDados['data']['descricao']) ? $aDados['data']['descricao'] : "" ?>" required placeholder="Salgados, doces, bebidas...">
                </div>
                ...
                <div class="form-group mt-4">
                    ...
                    <?php if ($acao != "view") : ?>
                        <button type="submit" value="submit" class="btn btn-<?= Helpers::$botoes[$aDados['acao']]['corBotao'] ?>"><?= Helpers::$botoes[$aDados['acao']]['textoBotao'] ?></button>
                    <?php endif; ?>
                </div>
            </div>
        </form>
