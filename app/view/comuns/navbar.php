        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        if ($_SESSION["userNivel"] == 1)
                        {
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                    <li><a class="dropdown-item" href="<?= SITE_URL ?>Categoria/lista"><i class="fas fa-tags"></i> Categorias</a></li>
                                    <li><a class="dropdown-item" href="<?= SITE_URL ?>Lanche/lista"><i class="fas fa-hamburger"></i> Lanches</a></li>
                                    <li><a class="dropdown-item" href="<?= SITE_URL ?>UsuarioAdmin/lista"><i class="fas fa-users-cog"></i> Usuários</a></li>
                                </ul>
                            </li>
                            <?php
                        }
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?= SITE_URL ?>Home/faleConosco"><i class="fas fa-envelope"></i> Fale Conosco</a>
                    </li>
                    ...
                    if (isset($_SESSION["userId"]))
                    {
                        if ($_SESSION['userNivel'] == "2")
                        {
                            ?>
                            <li class="nav-item">
                                <a class="nav-link" href="<?= SITE_URL ?>Carrinho/index"><i class="fas fa-shopping-cart"></i> Carrinho</a>
                            </li>
                            <?php
                        }
                        ?>
