                ...
                <div class="card-body">
                    <div class="m-sm-4">
                        <div class="text-center">
                            <img src="<?= SITE_URL ?>assets/img/astronautaHamburguer.jpg" 
                        ...
                        <form method="post" action="<?= SITE_URL ?>Login/register">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control" type="email" name="email" id="email" value="<?= $dados["email"] ?>" 
                                    maxlength="100" placeholder="Digite seu e-mail" readonly
                                >
                            </div>
                            <div class="row form-group mb-3">
                                <div class="col-6">
                                ...
                                <div class="col-6">
                                    ...
                                    <input class="form-control" type="password" name="confirmSenha" id="confirmSenha" 
                                        minlength="8" maxlength="15" placeholder="Confirme sua senha" required
                                    >
                                </div>
