                ...
                <tbody>
                    <?php foreach ($aDados['data'] as $value) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= SITE_URL ?>usuarioAdmin/form/view/<?= $value['id'] ?>" class="btn btn-secondary btn-sm btn-icons-crud" title="Visualizar">
                                ...
                                <a href="<?= SITE_URL ?>usuarioAdmin/form/update/<?= $value['id'] ?>" class="btn btn-secondary btn-sm btn-icons-crud" title="Alterar">
                                ...
                                <a href="<?= SITE_URL ?>usuarioAdmin/form/delete/<?= $value['id'] ?>" class="btn btn-secondary btn-sm btn-icons-crud" title="Excluir">
