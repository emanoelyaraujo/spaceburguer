                ...
                <tbody>
                    <?php foreach ($aDados['data'] as $value) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= SITE_URL ?>/lanche/form/view/<?= $value['id'] ?>" class="mb-1 btn btn-secondary btn-sm btn-icons-crud" title="Visualizar">
                                ...
                                <a href="<?= SITE_URL ?>/lanche/form/update/<?= $value['id'] ?>" class="mb-1 btn btn-secondary btn-sm btn-icons-crud" title="Alterar">
                                ...
                                <a href="<?= SITE_URL ?>/lanche/form/delete/<?= $value['id'] ?>" class="mb-1 btn btn-secondary btn-sm btn-icons-crud" title="Excluir">
