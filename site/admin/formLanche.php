        ...
        <form method="POST" action="<?= SITE_URL ?>lanche/<?= $aDados['acao'] ?>">
            <div class="row">
                <div class="form-group col-md-4 mb-3">
                    ...
                    <select name="id_categoria" class="form-control" id="id_categoria" <?= (isset($aDados['acao']) ? ($aDados['acao'] == 'view' || $aDados['acao'] == 'delete' ? "disabled" : "") : "") ?>>
                        <option value="">...</option>
                        <?php 
                        foreach ($aDados['categoria'] as $categoria)
                        {
                            foreach ($aDados['data'] as $data) 
                            {
                                var_dump($categoria, $data);
                             ?>
                ...
                <div class="form-group col-lg-6 mb-3">
                    ...
                    <input type="text" name="descricao" id="descricao" class="form-control" maxlength="250" <?= (isset($aDados['acao']) ? ($aDados['acao'] == 'view' || $aDados['acao'] == 'delete' ? "readonly" : "") : "") ?> value="<?= isset($aDados['data']['descricao']) ? $aDados['data']['descricao'] : "" ?>" required autofocus placeholder="X-Egge-bacon-burguer">
                </div>

                <div class="col-md-6">
                    <label for="ingredientes" class="form-label">Ingredientes</label>
                    <textarea class="form-control" id="ingredientes" name="ingredientes" <?= (isset($aDados['acao']) ? ($aDados['acao'] == 'view' || $aDados['acao'] == 'delete' ? "readonly" : "") : "") ?>>
                    ...
                    <div class="row">
                        <div class="col-3">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <input type="text" name="preco" id="preco" class="form-control" maxlength="5" <?= (isset($aDados['acao']) ? ($aDados['acao'] == 'view' || $aDados['acao'] == 'delete' ? "readonly" : "") : "") ?> value="<?= isset($aDados['data']['preco']) ? $aDados['data']['preco'] : "" ?>" placeholder="00,00">
                            </div>
                        </div>
                        <div class="col-5">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        let detalhamento = CKEDITOR.replace('ingredientes');
